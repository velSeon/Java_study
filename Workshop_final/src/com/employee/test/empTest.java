...
public static void main(String[] args) throws DataNotFoundException {
		...
		while (true) {
			printMainMenu();
			String inputMenu = CommonUtil.getUserInput(); //CommonUtil.getUserInput사용
		   ...
		   System.out.println("====================================================================================\n");
			...
			//4 근무지   5 연봉	  
				...
				case 2:
					...
					break;
				case 3:
					System.out.println("검색할 부서를 입력하세요 (1.영업 2.개발");
					break;
				case 4:
					System.out.println("검색할 근무지를 입력하세요");
					break;
				case 5:
					System.out.println("일력한 정보보다 많은 임직원을 모두 출력합니다.");
					System.out.println("검색할 연봉을 입력하세요.");
					break;
					...
					try {
						...
						Employee emp = null;
						if("1".equals(dname)){
							emp = new Sales(empno, ename,dname, hiredate,  loc, Integer.parseInt(sal), "근무", Integer.parseInt(sal)*Sales.COMMISSION_RATE);
						}else{
							emp = new Engineer(empno, ename,dname, hiredate,  loc, Integer.parseInt(sal), "근무");
						}
...
//		Employee emp = null;
//		if("1".equals(dname)){
//			emp = new Sales(Integer.parseInt(empno), ename,dname, null,  loc, Integer.parseInt(sal), "근무", Integer.parseInt(sal)*Sales.COMMISSION_RATE);
//		}else{
//			emp = new Engineer(Integer.parseInt(empno), ename,dname, null,  loc, Integer.parseInt(sal), "근무");
//		}
//			try {
//			empBiz.employeeInsert(emp);
//		} catch (DataNotFoundException e) {
